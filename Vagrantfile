...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "i4m3v4n-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/evans-training"
  #   chef.validation_client_name = "evans-training-validator"
  #   chef.validation_key_path = ".chef/evans-training-validator.pem"
  # end
end
